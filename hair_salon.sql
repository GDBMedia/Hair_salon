...
COPY clients (id, first_name, last_name, stylist, gender, age) FROM stdin;
\.
...
COPY stylists (id, first_name, last_name, name, specialty, gender, age) FROM stdin;
13	John	Jacobs	John Jacobs	mens hair	Male	20
\.
